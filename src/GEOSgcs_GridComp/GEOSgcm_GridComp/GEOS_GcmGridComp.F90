! $Id: GEOS_GcmGridComp.F90,v 1.30.2.1.4.4.2.2.2.1.2.11.2.5.2.3.4.1.4.1 2023/01/12 03:41:08 mmehari Exp $
...
!---------------------------------------------------------------------------
     ...
     if(DO_DATAATM/=0) then
        ...
        call MAPL_TerminateImport    ( GC,                             &
             SHORT_NAME = (/'TS_FOUND', 'SS_FOUND', 'FRZMLT  '/),      &
             CHILD      = AGCM,                                        &
             RC=STATUS  )
        VERIFY_(STATUS)
     end if
 ...
 contains
   ...
   subroutine AllocateExports_OBIO(DO_DATAATM, RC)
     ...
     if(DO_DATAATM==0) then
        ...
        call AllocateExports_UGD( GCM_INTERNAL_STATE%expSKIN,               &
             (/'DRBAND', 'DFBAND', 'FSWBAND  ', 'FSWBANDNA'/),              &
             RC=STATUS )
        VERIFY_(STATUS)
     endif
