...
!print*,'Edtop(nl) = ',Edtop(nl)
!print*,'Estop(nl) = ',Estop(nl)
      enddo
...
!print*,'WtoQ(nl) = ',Wtoq(nl)
      enddo
!print*,'Ebotq 1st = ',Ebotq
...
!   Detritus and PIC scattering
        ...
        do nl = 1,nlt
!        do nl = npst,npnd
!print*,'acdom(nl) = ',acdom(nl)
!print*,'Edz(nl,k) = ',Edz(nl,k)
!print*,'Esz(nl,k) = ',Esz(nl,k)
!print*,'Euz(nl,k) = ',Euz(nl,k)
!print*,'WtoQ(nl) = ',WtoQ(nl)
