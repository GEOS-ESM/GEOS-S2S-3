...
!_ --------------------------------------------------------------------
!_
!_ $Source: /cvsroot/esma/esma/src/Components/GEOSoceanbiogeochem_GridComp/Attic/co2calc_SWS.F90,v $ 
!_ $Revision: 1.1.2.2 $
!_ $Date: 2010/12/09 19:25:37 $   ;  $State: Exp $
!_ $Author: atrayano $ ;  $Locker:  $
!_
!_ ---------------------------------------------------------------------
!_ $Log: co2calc_SWS.F90,v $
