!  $Id: GEOS_CICEDynaGridComp.F90,v 1.26.2.97.4.10 2020/09/08 18:46:48 bzhao Exp $
...
!------------------------------------------------------
    ...
    call MAPL_GetResource( MAPL, OGCM_IM, Label="OGCM_IM:", RC=STATUS)
    VERIFY_(STATUS)
    call MAPL_GetResource( MAPL, OGCM_JM, Label="OGCM_JM:", RC=STATUS)
    VERIFY_(STATUS)
    call MAPL_GetResource( MAPL, OGCM_NX, Label="OGCM_NX:", RC=STATUS)
    VERIFY_(STATUS)
    call MAPL_GetResource( MAPL, OGCM_NY, Label="OGCM_NY:", RC=STATUS)
    VERIFY_(STATUS)
    ...
    call MAPL_GetResource (MAPL, STRENGTH,   Label="CICE_STRENGTH:",    DEFAULT=0,       RC=STATUS)
    VERIFY_(STATUS) 
    ...
    VERIFY_(STATUS) 
    call MAPL_GetResource (MAPL, MU_RDG,     Label="CICE_MU_RDG:",      DEFAULT=3.0,     RC=STATUS)
    VERIFY_(STATUS)
