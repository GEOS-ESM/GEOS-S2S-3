!  $Id: GEOS_DataSeaGridComp.F90,v 1.12.12.3.4.1.54.1.10.1.28.1.2.1.2.1.80.4.2.6 2018/06/12 19:27:53 yvikhlia Exp $
...
!--------------------
   ...
   if(associated(SW)) then
      SW = 30.0       ! SA: for now
!     SS_FOUND = SSS        ! SA: every SST data point must have SSS (in PSU) as well
   end if
