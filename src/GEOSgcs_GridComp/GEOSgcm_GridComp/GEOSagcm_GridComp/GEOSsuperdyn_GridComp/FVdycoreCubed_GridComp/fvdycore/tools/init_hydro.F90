...
!***********************************************************************
! $Id: init_hydro.F90,v 1.2.2.1.2.1.2.1.10.1.12.1.88.1.20.2.2.2.2.1.4.1.36.1 2018/02/26 17:46:31 wputman Exp $
...
!---- version number -----
      character(len=128) :: version = '$Id: init_hydro.F90,v 1.2.2.1.2.1.2.1.10.1.12.1.88.1.20.2.2.2.2.1.4.1.36.1 2018/02/26 17:46:31 wputman Exp $'
