...
!  $Id: GetWeights.F90,v 1.1.2.7.8.1.6.2.4.1.10.6.2.3.14.3.2.1.2.3.2.3 2017/12/18 15:14:13 bmauer Exp $
...
!-----------------------------------
      ...
      if (AmNodeRoot) then
         if (present(sublons) .and. present(sublats)) then
            write(c2l_fname,'(i5.5,"x",i5.5,"_c2l-subset_",i5.5,"x",i5.5,".nc4")') npx,npy,nlon,nlat
         else
