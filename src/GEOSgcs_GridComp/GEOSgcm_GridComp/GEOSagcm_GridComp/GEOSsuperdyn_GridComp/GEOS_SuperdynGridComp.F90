! $Id: GEOS_SuperdynGridComp.F90,v 1.75.10.2.14.1.44.1.4.1.4.3.106.1.28.1.10.1 2018/02/26 17:45:17 wputman Exp $
...
!BOR
    call MAPL_GetResource(MAPL, DYCORE, 'DYCORE:', default="FV", RC=STATUS )
!EOR
    VERIFY_(STATUS)
...
! Call Run Method for Children (FV)
!----------------------------------
