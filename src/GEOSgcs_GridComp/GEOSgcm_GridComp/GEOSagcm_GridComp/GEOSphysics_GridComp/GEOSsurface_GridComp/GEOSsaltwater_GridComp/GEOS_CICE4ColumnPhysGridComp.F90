!  $Id: GEOS_CICE4ColumnPhysGridComp.F90,v 1.1.2.16.2.10.2.10 2020/09/08 18:15:58 bzhao Exp $
...
!-----------------------------------
    ...
    VERIFY_(STATUS)
    call MAPL_GetResource ( MAPL, ALBICEV,   Label="ALBICEV:",           RC=STATUS)
    VERIFY_(STATUS)
    call MAPL_GetResource ( MAPL, ALBICEI,   Label="ALBICEI:",           RC=STATUS)
    VERIFY_(STATUS)
    call MAPL_GetResource ( MAPL, ALBSNOWV,  Label="ALBSNOWV:",          DEFAULT=0.98,              RC=STATUS)
    VERIFY_(STATUS)
    call MAPL_GetResource ( MAPL, ALBSNOWI,  Label="ALBSNOWI:",          DEFAULT=0.7,              RC=STATUS)
    VERIFY_(STATUS)
    ...
    VERIFY_(STATUS)
    call MAPL_GetResource ( MAPL, USTAR_MIN, Label="CICE_USTAR_MIN:",    DEFAULT=0.0005,             RC=STATUS)
    VERIFY_(STATUS)
    call MAPL_GetResource ( MAPL, AHMAX,     Label="CICE_AH_MAX:",       RC=STATUS)
    VERIFY_(STATUS)
    call MAPL_GetResource ( MAPL, SNOWPATCH, Label="CICE_SNOW_PATCH:",   DEFAULT=0.02,              RC=STATUS)
    VERIFY_(STATUS)
    call MAPL_GetResource ( MAPL, DALB_MLT,  Label="CICE_DALB_MLT:",     RC=STATUS)
    VERIFY_(STATUS)
