...
!  $Id: GEOS_SaltWaterGridComp.F90,v 1.40.14.2.4.2.4.2.6.9.4.5.42.1.2.2.2.1.2.1.2.1.28.38.2.21.2.1.2.8.2.1.4.1 2023/01/12 03:41:08 mmehari Exp $
...
! Atmosphere-Ocean Interface Layer (AOIL) specific variables
  ...
  call MAPL_AddConnectivity ( GC,   &
        !SHORT_NAME  = (/'FRESH','FSALT','FHOCN',           &
        !                'FRACI', 'FRACINEW','TFREEZE',     &
        !                'DRUVRTHRU','DFUVRTHRU',           &
        !                'DRPARTHRU','DFPARTHRU'/),         &
       SHORT_NAME  = (/'FRACI', 'FRACINEW','TFREEZE'/),     & 
       DST_ID = WATER,              &
       SRC_ID = ICE,                &
       RC=STATUS  )
  VERIFY_(STATUS)
