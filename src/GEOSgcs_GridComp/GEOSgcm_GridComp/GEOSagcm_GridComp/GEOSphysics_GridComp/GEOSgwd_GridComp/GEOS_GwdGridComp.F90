...
!  $Id: GEOS_GwdGridComp.F90,v 1.37.6.1.8.1 2018/02/26 17:44:58 wputman Exp $
...
! !IMPORT STATE:
     ...
     call MAPL_AddImportSpec(GC,                             &
        SHORT_NAME = 'QI',                                        &
        LONG_NAME  = 'specific_humidity_of_suspended_ice',        &
        UNITS      = 'kg kg-1',                                   &
        DIMS       = MAPL_DimsHorzVert,                           &
        VLOCATION  = MAPL_VLocationCenter,                        &
                                                       RC=STATUS  )
     ...
     call MAPL_AddImportSpec(GC,                             &
        SHORT_NAME = 'LS_PRCP',                                   &
        LONG_NAME  = 'Total_LS_Surface_precipitation_flux',       &
        UNITS      = 'kg m-2 s-1',                                &
        DIMS       = MAPL_DimsHorzOnly,                           &
        VLOCATION  = MAPL_VLocationNone,                          &
                                                       RC=STATUS  )
...
!  Pointers from Import state
      ...
      real, pointer, dimension(:,:)    :: SGH, PRECIP
      real, pointer, dimension(:,:,:)  :: PLE, T, Q, QI, U, V
...
!---------------------
      ...
      call MAPL_GetPointer( IMPORT, PRECIP, 'LS_PRCP', RC=STATUS ); VERIFY_(STATUS)
