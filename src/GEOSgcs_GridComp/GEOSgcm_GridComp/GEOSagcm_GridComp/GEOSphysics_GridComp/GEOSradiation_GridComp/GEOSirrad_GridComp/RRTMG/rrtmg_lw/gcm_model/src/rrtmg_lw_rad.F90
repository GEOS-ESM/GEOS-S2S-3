...
#include "_gpudef.inc"
   ...
   contains
      ...
      subroutine rrtmg_lw( &
            ...
            duflx_dt,duflxc_dt, cloudFlag, dyofyr, alat, numCPUs)
         ! -------- Description --------
         ...
         use parrrtm, only : nbndlw, ngptlw, maxxsec, mxmol, mxlay, nbndlw
      ...
      subroutine rrtmg_lw_part &
         ...
         use parrrtm, only : nbndlw, ngptlw, maxxsec, mxmol, mxlay, nbndlw, nmol
         use rrlw_con, only: fluxfac, heatfac, oneminus, pi
         ...
         call mcica_subcol_lwg(1, pncol, nlay, icld, counter, 0, play, cldfracq, ciwpq, &
