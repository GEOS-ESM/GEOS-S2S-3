!     path:      $Source: /cvsroot/esma/esma/src/Components/GEOSsolar_GridComp/RRTMG/rrtmg_sw/gcm_model/src/mcica_subcol_gen_sw.F90,v $
!     author:    $Author: mathomp4 $
!     revision:  $Revision: 1.1.1.1.30.3 $
!     created:   $Date: 2015/03/06 18:11:53 $
!
