...
!     path:      $Source: /cvsroot/esma/esma/src/Components/GEOSsolar_GridComp/RRTMG/rrtmg_sw/gcm_model/src/rrtmg_sw_spcvmc.F90,v $
!     author:    $Author: mathomp4 $
!     revision:  $Revision: 1.1.1.1.2.3.102.1.2.2 $
!     created:   $Date: 2018/02/13 16:14:01 $
