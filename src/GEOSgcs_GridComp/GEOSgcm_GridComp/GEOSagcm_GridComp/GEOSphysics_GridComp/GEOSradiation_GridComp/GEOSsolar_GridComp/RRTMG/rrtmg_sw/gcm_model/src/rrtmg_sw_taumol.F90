!     path:      $Source: /cvsroot/esma/esma/src/Components/GEOSsolar_GridComp/RRTMG/rrtmg_sw/gcm_model/src/rrtmg_sw_taumol.F90,v $
!     author:    $Author: mathomp4 $
!     revision:  $Revision: 1.1.1.1.100.4 $
!     created:   $Date: 2018/02/12 16:22:03 $
