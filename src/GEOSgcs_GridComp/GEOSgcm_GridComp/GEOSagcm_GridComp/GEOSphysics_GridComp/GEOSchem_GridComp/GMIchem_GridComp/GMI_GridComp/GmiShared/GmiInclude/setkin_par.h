!=======================================================================
!
! $Id: setkin_par.h,v 1.1.18.1.46.1.20.1 2011/11/04 13:25:32 jnielsen Exp $
!
! FILE
!   setkin_par.h
!   12 JUN 02 - PSC
...
!.... Species affiliations and assignments
     ...
     & ,NSS
      ...
      parameter (NACT   = 117) !Used with ibcb in setkin_ibcb.h
      parameter (NCHEM  = 121) !Apparently not used
      parameter (NCONST =   4) !Apparently not used
      parameter (NDYN   = 118) !Sizes ldynvar(NDYN) in setkin_lchem.h
      parameter (NFAM   =   2) !Probably replaced by NUMGRP in setkin_group.h
      parameter (NMF    = 118) !Sizes specarr in setkin_kcalc.F90
      parameter (NSS    =   0)
