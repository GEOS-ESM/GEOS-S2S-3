!=============================================================================
!
! $Id: wetdep_update.F90,v 1.1.1.1.28.1.66.1.12.1 2011/02/11 16:16:48 jkouatch Exp $
!
! CODE DEVELOPER
!   Dan Bergmann, LLNL
!   dbergmann@llnl.gov
...
!             =======================
              call Calc_Wet_Loss_Rate  &
!             =======================
     &          (.false., ic, ih2o2_num, delh_298_over_r(ic), hstar(ic),  &
     &           retention_eff(ic), press3e(:,ij,ik),  &
...
!-----------------------------------------------------------------------------
     ...
     &  (convective, ic, ih2o2_num, delh_298_over_r, hstar,  &
