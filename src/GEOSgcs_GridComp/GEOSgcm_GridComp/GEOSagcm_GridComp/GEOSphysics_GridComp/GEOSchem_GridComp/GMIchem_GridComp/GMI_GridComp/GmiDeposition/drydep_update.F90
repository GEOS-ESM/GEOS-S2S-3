...
!=============================================================================
!
! $Id: drydep_update.F90,v 1.1.1.1.2.1.20.1.66.1.166.1 2016/12/22 21:54:20 mmanyin Exp $
!
! CODE DEVELOPER
!   Dan Bergmann, LLNL
!   dbergmann@llnl.gov
...
!       ===========
     ...
     &    hstar, mw, aerosol, ustar(:,ij), cz1, obk, fracCloudCover(:,ij),  &
     &    lwi_flags(i1,ij), dvel, ireg, iland, iuse, xlai, diffa,  &
     &    s_ra, s_vel, delh_298_over_r, i1, i2, ju1, j2, num_species)
...
!-----------------------------------------------------------------------------
      ...
      subroutine Depvel  &
     &  (npts, ij, radiat, tempk, suncos, f0, hstar, xmw, airosol,  &
...
!     ----------------------
      ...
      real*8  :: delh_298_over_r(num_species)
