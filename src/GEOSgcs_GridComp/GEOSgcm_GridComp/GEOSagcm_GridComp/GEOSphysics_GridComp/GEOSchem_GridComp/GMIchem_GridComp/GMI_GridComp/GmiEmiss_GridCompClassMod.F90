...
! Is the GCM executing the predictor step of REPLAY at this momement?
! -------------------------------------------------------------------
...
!
   ...
   USE GmiTimeControl_mod,            ONLY : Set_gmiTimeStep, Set_numTimeSteps
...
!-------------------------------------------------------------------------
   ...
   REAL :: qmin, qmax
   REAL(KIND=DBL) :: chemDt, tr_source_land, tr_source_ocean
...
! ---------------
   ...
   CALL Set_gmiTimeStep(self%gmiClock, chemDt)
...
! ----------------------------------------------------------
     ...
     &               self%gmiGrid, self%gmiClock, gmiConfigFile, self%cellArea, IHNO3, IO3, &
     &               NSP, loc_proc, rootProc, self%chem_opt, self%trans_opt, &
     &               self%pr_diag,   &
     &               self%pr_const, self%pr_surf_emiss, self%pr_emiss_3d)
