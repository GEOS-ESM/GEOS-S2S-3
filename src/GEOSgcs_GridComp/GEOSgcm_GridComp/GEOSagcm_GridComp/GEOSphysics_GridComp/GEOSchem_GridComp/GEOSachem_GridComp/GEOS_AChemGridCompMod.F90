...
! !OUTPUT PARAMETERS:
   ...
   real, pointer, dimension(:,:,:), intent(out) :: pSO2_OCS      ! production of S from OCS in the stratosphere
   real, pointer, dimension(:,:,:), intent(out) :: pSO2_OCS_OH   ! production of S from OCS+OH
   real, pointer, dimension(:,:,:), intent(out) :: pSO2_OCS_O3p  ! production of S from OCS+O3p
   real, pointer, dimension(:,:,:), intent(out) :: pSO2_OCS_jOCS ! production of S from OCS photolysis
   real, pointer, dimension(:,:,:), intent(out) :: lOCS          ! loss ocs, 'molecules cm-3 s-1'
   real, pointer, dimension(:,:,:), intent(out) :: lOCS_OH       ! loss rate of OCS from OCS+OH, 'molec cm-3 s-1'
   real, pointer, dimension(:,:,:), intent(out) :: lOCS_O3p      ! loss rate of OCS from OCS+O3p, 'molec cm-3 s-1'
   real, pointer, dimension(:,:,:), intent(out) :: lOCS_jOCS     ! loss rate of OCS from photolysis, 'molec cm-3 s-1'
