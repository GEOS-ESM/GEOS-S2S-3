...
expid='@EXPID'
cmpexp='@EXPID'
version='S2Sv3' # Options: S2Sv2, S2Sv3
data_path='@EXPDIR'
...
fmt={
    'geosgcm_ocn2d':{
        'MONTHLY': '{data_path}/{collection}/{expid}.{collection}.monthly.{year}{month}.nc4',
        'DAILY'  : '{data_path}/{collection}/{expid}.{collection}.monthly.{year}{month}{day}_1500z.nc4'
        },
    'MOM_Output': '{data_path}/{collection}/ocean_month.e{year}{month}01_00z.nc'
}

or for S2Sv3

fmt={
    'ocn_tavg_1mo_glo_L720x361_slv':{
        'MONTHLY': '{data_path}/{collection}/{expid}.{collection}.{year}{month}01_0000z.nc4'},
    'ocn_tavg_1mo_glo_L720x361_z50':{
        'MONTHLY': '{data_path}/{collection}/{expid}.{collection}.{year}{month}01_0000z.nc4'}
}
