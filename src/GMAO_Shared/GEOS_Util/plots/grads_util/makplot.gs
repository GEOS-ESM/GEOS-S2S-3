...
'set string 1 l 4'
'set strsiz .08'
'draw string 0.005 10.50 Beg: 'bmnthm' 'byearm
'draw string 0.005 10.35 End: 'emnthm' 'eyearm
'draw string 0.005 7.10 Beg: 'bmntho' 'byearo
'draw string 0.005 6.95 End: 'emntho' 'eyearo
...
'myprint -name 'output'/'name''mathparm'_'PFX''oname'.'season
endif
