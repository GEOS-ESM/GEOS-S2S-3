...
if( level = 0 )
    if( m != 0 )
   'draw string 4.25 10.64 'expdsc'  'season' ('nmod') (x 10**'m')'
    else
   ...
   'draw string 4.25 3.80 Difference (Top-Middle)'
    ...
    if( m != 0 )
   'draw string 4.25 10.64 'expdsc'  'level'-mb  'season' ('nmod') (x 10**'m')'
    else
   'draw string 4.25 10.64 'expdsc'  'level'-mb  'season' ('nmod')'
    endif
   'draw string 4.25 7.24 'obsname'  'season' ('nobs')  ('climate')'
   if( k != 0 )
...
'set string 1 l 4'
'set strsiz .08'
'draw string 0.007 10.48 Beg: 'bmnthm' 'byearm
'draw string 0.007 10.33 End: 'emnthm' 'eyearm
'draw string 0.007 7.09 Beg: 'bmntho' 'byearo
'draw string 0.007 6.93 End: 'emntho' 'eyearo

'draw string 0.007 9.85  Mean: 'avgmod
'draw string 0.007 9.70  Std: 'stdmod
'draw string 0.007 6.45 Mean: 'avgobs
'draw string 0.007 6.30  Std: 'stdobs
'draw string 0.007 3.05 Mean: 'avgdif
'draw string 0.007 2.90  Std: 'stddif
