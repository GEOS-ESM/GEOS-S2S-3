...
if( rms = 3 ) ; 'define q'm' = sqrt( 'field'rmsdsp'n.m' )' ; endif
if( rms = 4 ) ; 'define q'm' = sqrt( 'field'rmsdis'n.m' )' ; endif
'define z'n'e'm' = q'm
n = n + 1
endwhile
m = m + 1
...
'set dfile 'ddif.m
'set t 'tbeg.m' 'tdif.m
if( rms = 0 ) ; 'define ctl  =       'field'rms'n        ; 'define dum  =       'field'rms'n.m         ; endif
if( rms = 1 ) ; 'define ctl  =       'field'rmsran'n     ; 'define dum  =       'field'rmsran'n.m      ; endif
if( rms = 2 ) ; 'define ctl  =       'field'rmsbar'n     ; 'define dum  =       'field'rmsbar'n.m      ; endif
if( rms = 3 ) ; 'define ctl  = sqrt( 'field'rmsdsp'n' )' ; 'define dum  = sqrt( 'field'rmsdsp'n.m' ) ' ; endif
if( rms = 4 ) ; 'define ctl  = sqrt( 'field'rmsdis'n' )' ; 'define dum  = sqrt( 'field'rmsdis'n.m' ) ' ; endif
'define     dq'm' = (ctl-dum)'
...
if( nday = ndaymax )
   'myprint -name 'SOURCE'/corcmp/stats_'label'_rmscmp_'reg'_'level'_'months' -rotate 90 -density 100x100'
else
   'myprint -name 'SOURCE'/corcmp/stats_'label'_rmscmp_'reg'_'level'_'months'_'nday'DAY -rotate 90 -density 100x100'
endif
