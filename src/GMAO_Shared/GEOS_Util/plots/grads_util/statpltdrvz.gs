...
'set grads off'
'set grid  off'
'run statdpltz 'field' Dmes 'tag1' 'tag2' 'numf' 'cint
...
'set grads off'
'set grid  off'
'run statdpltz 'field' Dvar 'tag1' 'tag2' 'numf' 'cint
...
'set grads off'
'set grid  off'
'run statdpltz 'field' Dmse 'tag1' 'tag2' 'numf' 'cint
...
'set grads off'
'set grid  off'
'run statdpltz 'field' Dres 'tag1' 'tag2' 'numf' 'cint
