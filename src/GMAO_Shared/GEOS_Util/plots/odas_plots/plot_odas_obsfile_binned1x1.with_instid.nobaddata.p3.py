...
#       print 'sensor2 is', sensor2
    ...
    if(sensor[0] == 'ALL' and obstyp == 'SSH'):
        ALLsensor=['CryoSat-2', 'Jason-1','Jason-2','Jason-3', 'Saral', 'Sentinel-3a', 'ERS-1', 'ERS-2', 'TOPEX', 'GEOSAT-2', 'Envisat', 'HY-2A', 'Sentinel-6a']
        sensor2=ALLsensor
...
#       print ssize
    ...
    if ( (obsid[0]==5351) | (obsid[0]==5525) | (obsid[0]==5522) ):
        ...
        cl = ax.scatter(lon2, lat2, 1, c=gridout2,
                   cmap=cm.jet, vmin=valmin, vmax=valmax, edgecolor=None)
        ax.colorbar(cl, shrink=0.5)
