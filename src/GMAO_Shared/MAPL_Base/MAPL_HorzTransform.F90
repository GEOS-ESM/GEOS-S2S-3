...
!  $Id: MAPL_HorzTransform.F90,v 1.17.10.4.12.1 2017/04/21 16:59:29 bmauer Exp $
...
!   used by FV.
  ...
  character(ESMF_MAXPATHLEN) :: HorzTrans_TilePath = '.'
...
!  on the fly
  ...
  subroutine MAPL_HorzTransformInit(TilePath,rc)
    ...
    RETURN_(SUCCESS)
  end subroutine MAPL_HorzTransformInit
