               ...
               case ("PrimaryExports%%")
                  ...
                  do while(inBLock)
                     ...
                     if (trim(thisLine) == "%%") then
                        ...
                        !call ESMF_UtilStringLowerCase(buffer, iret)
                        ...
                        ! climatology entry
                        call ESMF_ConfigGetAttribute(CFtemp, buffer, __RC__)
                        call ESMF_StringLowerCase(buffer, __RC__)
...
!  check for PS
   ...
   if (any(self%primary%item%do_VertInterp .eqv. .true.)) then
      ...
      call ESMF_StringUppercase(self%primary%item(idx)%units,status)
...
! ............................................................................
  ...
  type (ESMF_Time) function timestamp_(time, template, rc)
     ...
     buff = trim(template)
     call ESMF_StringLowerCase(buff, status)
  ...
  subroutine GetLevs(item, time, allowExtrap, rc)
     ...
     if (item%frequency == zero) then
        ...
        call ESMF_StringLowerCase(buff,__RC__)
     ...
     call ESMF_StringUpperCase(varname,status)
     do i=1,nVars
  ...
  subroutine  MAPL_ExtDataReadVector(item,file,ExtState,side,rc )
     ...
     if (fieldRank == 2) then
         ...
         if (gridStagger1 == MAPL_CGrid) then
             call A2D2C(v1out_3d,v2out_3d,1,.true.)
         else if (gridStagger1 == MAPL_DGrid) then
             call A2D2C(v1out_3d,v2out_3d,1,.false.)
         end if
         ...
         call MAPL_HorzTransformRun (trans, v1in_3d, v2in_3d, v1out_3d, v2out_3d, undef= MAPL_UNDEF, rotate=doRotation, __RC__)
         ...
         if (gridStagger1 == MAPL_CGrid) then
            call A2D2C(v1out_3d,v2out_3d,lmOut,.true.)
         else if (gridStagger1 == MAPL_DGrid) then
            call A2D2C(v1out_3d,v2out_3d,lmOut,.false.)
         end if
