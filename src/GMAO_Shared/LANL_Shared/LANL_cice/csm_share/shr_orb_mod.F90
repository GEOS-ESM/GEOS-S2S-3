!===============================================================================
! CVS: $Id: shr_orb_mod.F90,v 1.1.1.1.14.1 2012/10/11 20:49:50 bzhao Exp $
! CVS: $Source: /cvsroot/esma/esma/src/Components/GEOSCICEThermo_GridComp/cice/csm_share/shr_orb_mod.F90,v $
...
!-------------------------------------------------------------------------------
   ...
   if ( log_print ) then
     ...
     write(6,F00) 'CVS revision: $Revision: 1.1.1.1.14.1 $'
     write(6,F00) 'CVS Tag     : $Name: GEOS-S2S-3_20231512 $'
   end if
