...
rm -f  $EXPERIMENT_PATH/ocean_das/oana-*/*
rm -f  $EXPERIMENT_PATH/ocean_das/oana-*/ocean_observer_*/*.dat
rm -f  $EXPERIMENT_PATH/ocean_das/oana-*/ocean_observer_*/*.dat.nc
rm -f  $EXPERIMENT_PATH/ocean_das/tmpcice*
