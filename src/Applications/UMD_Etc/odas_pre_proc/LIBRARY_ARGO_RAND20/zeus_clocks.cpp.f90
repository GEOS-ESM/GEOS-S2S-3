!DIR$ ID "%Z%	$RCSfile: zeus_clocks.cpp.f90,v $ %Y% $Date: 2023/12/05 20:21:02 $ $Revision: 1.1 $"
...
!DIR$ ID "%Z%	%Y% $Id: zeus_clocks.cpp.f90,v 1.1 2023/12/05 20:21:02 yvikhlia Exp $ P Schopf"
!*------------------------------------
