MODULE DATA_ID_MODULE
  
  IMPLICIT NONE
  PUBLIC :: get_wmo_tao, get_wmo_pir, get_wmo_rama, get_wmo_xbt
 ...
 ! ..........................................................................
  ...
  ! list = 1 for current list
    ...
    if (list==0) then
      fname = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/ARGO/ARGO_WMO_MASTER.txt' 
    elseif (list==1) then
      fname = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/ARGO/ARGO_WMO_CURRENT.txt' 
    endif
    open (UNIT, file=fname(1:len_trim(fname)), status='old', form='formatted')  
    ieof = 0
    cnt = 1 
  ...
  ! list = 1 for current list
    ...
    if (list==0) then
      fname = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/CTD/MET_CTD_WMO_MASTER.txt' 
    elseif (list==1) then
      fname = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/CTD/MET_CTD_WMO_CURRENT.txt' 
    endif
    open (UNIT, file=fname(1:len_trim(fname)), status='old', form='formatted')  
    ieof = 0
    cnt = 1 
  ...
  ! src  = meto,ncep,both
    ...
    if (list==0) then
      if (src=='meto') then
        fname = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/XBT/MET_XBT_WMO_MASTER.txt' 
  ...
  ! Find out if WMO is really an Argo
   ...
   fname_master  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/ARGO/ARGO_WMO_MASTER.txt'    
     open (10, file=trim(fname_master),status='old',position = 'append',form='formatted')     

  ! Get last record of data_id
    fname_data_id = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/ARGO/ARGO_WMO_DATA_ID.txt'    
  ...
  ! Find out if WMO is really an Argo
   ...
   fname_master  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/CTD/MET_CTD_WMO_MASTER.txt'    
     open (10, file=trim(fname_master),status='old',position = 'append',form='formatted')     

  ! Get last record of data_id
    fname_data_id = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE//METOFFICE/EN3_v2a/CTD/MET_CTD_WMO_DATA_ID.txt'    
    open (20, file=trim(fname_data_id),status='old',form='formatted')     
    ieof = 0
    DO WHILE (ieof == 0)
     read (20, '(A,I8)',iostat = ieof) tmp, data_id
  ...
  !
    ...
    if (kx==508) then
      fname_in1  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/ARGO/ARGO_WMO_DATA_ID.txt' 
      fname_in2  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/ARGO/ARGO_WMO_MASTER.txt' 
    elseif (kx==503 .and. src=='met') then
      fname_in1  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v1d/MET_XBT_WMO_DATA_ID.txt' 
      fname_in2 = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v1d/MET_XBT_WMO_MASTER.txt' 
    ...
    elseif (kx==513 .and. src=='ctd') then
      fname_in1  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/CTD/MET_CTD_WMO_DATA_ID.txt' 
      fname_in2 = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/CTD/MET_CTD_WMO_MASTER.txt' 
    endif
  ...
  !
    ...
    if (kx==508) then
      fname_in  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/ARGO/ARGO_WMO_MASTER.txt' 
      fname_out  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/ARGO/ARGO_WMO_DATA_ID.txt' 
    elseif (kx==503 .and. src=='met') then
      fname_in  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/XBT/MET_XBT_WMO_MASTER.txt' 
      fname_out = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/XBT/MET_XBT_WMO_DATA_ID.txt' 
      maxcnt    = 850000
      data_id0  = (kx*100000)-1;
      max_id    = (kx+1)*100000;  
    elseif (kx==513) then
      fname_in  = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/CTD/MET_CTD_WMO_MASTER.txt' 
      fname_out = '/discover/nobackup/projects/gmao/ssd/g5odas/production/GEOS5odas-5.00/PRE/METOFFICE/EN3_v2a/CTD/MET_CTD_WMO_DATA_ID.txt' 
      maxcnt    = 850000
      data_id0  = (kx*100000)-1;
      max_id    = (kx+1)*100000;  
    endif
