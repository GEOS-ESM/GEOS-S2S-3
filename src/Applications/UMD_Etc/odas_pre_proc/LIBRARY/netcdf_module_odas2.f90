MODULE NETCDF_MODULE_ODAS2
  ...
  ! .................................................................
   ...
   ! *****************************************************************!
    ...
    !print *, 'In module', maxnobs, nobs, nlevs
  ...
  ! .................................................................
    SUBROUTINE read_netcdf_init(fname_in,N_PROF_len, N_LEVS_len)
  ! .................................................................
    IMPLICIT NONE
    INCLUDE 'netcdf.inc'
  ...
  ! Open Dataset
  ! ............................
    fname_trim = adjustr(fname_in)
    status = nf_open(fname_trim, 0, ncid)
...
END MODULE NETCDF_MODULE_ODAS2
