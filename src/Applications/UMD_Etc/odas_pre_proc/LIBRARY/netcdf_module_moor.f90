MODULE NETCDF_MODULE_MOOR
  ...
  ! .................................................................
   ...
   ! *****************************************************************!
    ...
    history     = 'Created on ' // current_date // ' by Li Ren'   
    conventions = 'COARDS'
  ...
  ! .................................................................
    SUBROUTINE write_netcdf(fname_out,maxnobs,nobs,nlevs,inst_error,&
               var_id,miss,date_time,lon,lat,npts,qc_flag,data_id,inst_id, &
               qc_prf,depth,field,qc_lev,obs_error,title,source,svar,mlen)
  ! .................................................................
    IMPLICIT NONE
    INCLUDE 'netcdf.inc'
 
    character*256, intent(in) :: fname_out
    integer,       intent(in) :: maxnobs, nobs, nlevs, var_id, mlen
    real,          intent(in) :: miss, inst_error
   ...
   ! Create netcdf file and ncid
     status = nf_create(fname_trim, nf_write, ncid)
     !print *, 'create ', status
  ...
  ! .................................................................
   ...
   ! *****************************************************************!
    ...
    call DATE_AND_TIME(current_date)
    history     = 'Updated on ' // current_date // ' by Li Ren'
  ...
  ! .................................................................
    SUBROUTINE read_netcdf_init(fname,N_PROF_len, N_LEVS_len, moor, nlen)
  ! .................................................................
    IMPLICIT NONE
    INCLUDE 'netcdf.inc'
...
!    fname_trim_arg = adjustr(fname)
  ...
  ! ..................................................................................
    ...
    integer,       intent(in) :: max_nobs, max_npts, nlen
    character*256, intent(in) :: fname
    character*78              :: fname_trim_ram
    character*76              :: fname_trim_tao
    character*79              :: fname_trim_pir
