...
%pathfinal    = '/gpfsm/dnb04/projects/p71/aogcm/g5odas/obs/assim/TAO/V3/FINAL/';
%pathfinal    = '/gpfsm/dnb78s2/projects/p26/ehackert/TAO_PIRATA_RAMA_processing/MOOR/TAO/V3/FINAL/';

pathfinal    = '/discover/nobackup/lren1/pre_proc/NRT/MOOR/TAO/V3/FINAL/';
...
for iyear=syear:eyear,
  ...
  fnames=[pathfinal,'SYN_TAO_',syear,'.nc'];
%    s_cdf = netcdf(fnames,'read');
  ...
  fnamet=[pathfinal,'T_TAO_',syear,'.nc'];
