...
#   print
    ...
    print("time")
    print(gmi.variables['time'][0,273:278,169:175])        # RSS verify_gmi_v8.1.txt is messed up with time

    print("sst")
    print(gmi.variables['sst'][0,273:278,169:175])

    print("wind speed low freq")
    print(gmi.variables['windLF'][0,273:278,169:175])

    print("wind speed med freq")
    print(gmi.variables['windMF'][0,273:278,169:175])

    print("water vapor")
    print(gmi.variables['vapor'][0,273:278,169:175])

    print("cloud")
    print(gmi.variables['cloud'][0,273:278,169:175])

    print("rain")
    print(gmi.variables['rain'][0,273:278,169:175])
