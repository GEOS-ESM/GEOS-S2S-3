...
#######################################################################
cp ${GEOSDIR}/src/Applications//UMD_Etc/UMD_scripts/ocean_das* . 
...
cp $GEOSDIR/src/Applications/UMD_Etc/UMD_scripts/ocean_das* .
cp $GEOSDIR/src/Applications/UMD_Etc/UMD_scripts/oda_run.j .
cp $GEOSDIR/src/Applications/UMD_Etc/UMD_scripts/MOtoM2O.py .
