...
contains
  ...
  !------------------------------------------
    ...
    if (VAR_NAME .eq.'temp') then
     if ( minval(VAR).lt.-8.   ) print*,' Min PERT ErrVAR< -8:',minval(VAR)
     if ( minval(CVAR).lt.-8.  ) print*,' Min ASSI ErrVAR< -8:',minval(CVAR)
     if ( minval(NVAR).lt.-8   ) print*,' Min BV   ErrVAR< -8:',minval(NVAR)
     if ( minval(PVAR).lt.-8.  ) print*,' Min BV   ErrVAR< -8:',minval(PVAR)
